document.write(`<div class="w3-top">
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
    ...
    <a href="teaching.html" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Teaching</a>
    <a href="photos.html" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Photography</a>
  </div>
</div>`)